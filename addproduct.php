      ...
      <center>
        <div class="mycardstyle">
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off" method="POST" action="/newconnectdb.php">
                    <div class="formitem">
                        <label type="text" class="formlabel"> Product Name </label>
                        <input type="text" class="forminput" id="prodname" required>
                        <!-- <label for="product_image" class="formlabel">Product Image:</label>
                        <input type="file" id="product_image" name="product_image"><br> -->
                        <label type="text" class="formlabel"> Product Description </label>
                        <input type="text" class="forminput" id="des" required>
                        <label type="text" class="formlabel"> Price </label>
                        <input type="text" class="forminput" id="price" required>
