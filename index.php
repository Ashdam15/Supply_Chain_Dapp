...
<html lang="en">
  <head>
    ...
    <title>Identification of fake products using Blockchain</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4>Identification of Fake Products</h4>
            <p style="max-width: 80%;">
            This is a decentralized App which is used to identify counterfeit Products with the help of QR code. This system is also capable of transferring the ownership. This technology makes it possible for customers
to independently confirm the legitimacy of a product, which benefits both them and the product’s owner
            </p>
      ...
      <div class="loginformcard" id="maincard3">
            ...
            <form class="form1" style="margin-top: 30px; margin-bottom: 30px;" action="registration.php" method="POST" onsubmit="return checkSecondForm(this);">
